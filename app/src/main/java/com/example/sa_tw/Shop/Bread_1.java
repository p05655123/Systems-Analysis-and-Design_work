...
public class Bread_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bread_1);
        mTimer = new Timer();

        this.mediator = Mediator.getInstance();
        mediator.setBread_1_GUI(this);
    ...
    private void setTimerTask1() {
        mTimer.schedule(new TimerTask() {
            @Override
            public void run() {
                mediator.output_bname2();
                mediator.output_bprice2();
                mediator.output_binventory2();
    ...
    private View.OnClickListener show_bread_2_gui = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            mediator.show_bread_2_GUI();
        }
    };
        ...
        public void onClick(View v) {
            if(((Integer.valueOf(String.valueOf(q.getText())))<= 0) || (q.getText().toString().trim().isEmpty())){
                ...
                if(Integer.valueOf(q.getText().toString()) > inventory){
                    ...
                    mediator.intocart(12,Integer.valueOf(q.getText().toString()),Integer.valueOf(q.getText().toString())*price);
                    q.setText("");
                }
            }
        }
