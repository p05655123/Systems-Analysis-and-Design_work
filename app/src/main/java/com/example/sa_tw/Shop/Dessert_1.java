...
public class Dessert_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediator.setDessert_1_GUI(this);
    ...
    private void setTimerTask1() {
        mTimer.schedule(new TimerTask() {
            @Override
            public void run() {
                mediator.output_dname2();
                mediator.output_dprice2();
                mediator.output_dinventory2();
                handler.sendEmptyMessage(0);
            }
        }, 500);
    }
    private View.OnClickListener show_dessert_2_gui = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            mediator.show_dessert_2_GUI();
        }
    };
        ...
        public void onClick(View v) {
            if(((Integer.valueOf(String.valueOf(q.getText())))<= 0) || (q.getText().toString().trim().isEmpty())){
                ...
                if(Integer.valueOf(q.getText().toString()) > inventory){
                    ...
                    mediator.intocart(4,Integer.valueOf(q.getText().toString()),Integer.valueOf(q.getText().toString())*price);
                    q.setText("");
                }
            }
        }
