...
public class Stationery_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stationery_2);
        mTimer = new Timer();

        this.mediator= Mediator.getInstance();
        mediator.setStationery_2_GUI(this);
    ...
    private void setTimerTask1() {
        mTimer.schedule(new TimerTask() {
            @Override
            public void run() {
                mediator.output_sname3();
                mediator.output_sprice3();
                mediator.output_sinventory3();
                handler.sendEmptyMessage(0);
            }
        }, 500);
    }
    private View.OnClickListener show_stationery_3_gui = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            mediator.show_stationery_3_GUI();
        }
    };
        ...
        public void onClick(View v) {
            if(((Integer.valueOf(String.valueOf(q.getText())))<= 0) || (q.getText().toString().trim().isEmpty())){
                ...
                if(Integer.valueOf(q.getText().toString()) > inventory){
                    ...
                    mediator.intocart(1,Integer.valueOf(q.getText().toString()),Integer.valueOf(q.getText().toString())*price);
                    q.setText("");
                }
            }
        }
