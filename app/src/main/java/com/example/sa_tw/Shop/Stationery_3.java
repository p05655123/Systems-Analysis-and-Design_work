...
public class Stationery_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stationery_3);
        mTimer = new Timer();

        this.mediator= Mediator.getInstance();
        mediator.setStationery_3_GUI(this);
    ...
    private void setTimerTask1() {
        mTimer.schedule(new TimerTask() {
            @Override
            public void run() {
                mediator.output_sname4();
                mediator.output_sprice4();
                mediator.output_sinventory4();
        ...
        public void onClick(View v) {
            if(((Integer.valueOf(String.valueOf(q.getText())))<= 0) || (q.getText().toString().trim().isEmpty())){
                ...
                if(Integer.valueOf(q.getText().toString()) > inventory){
                    ...
                    mediator.intocart(8,Integer.valueOf(q.getText().toString()),Integer.valueOf(q.getText().toString())*price);
                    q.setText("");
                }
            }
        }
