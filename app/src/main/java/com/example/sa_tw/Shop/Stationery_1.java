...
public class Stationery_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stationery_1);
        mTimer = new Timer();

        this.mediator= Mediator.getInstance();
        mediator.setStationery_1_GUI(this);
    ...
    private void setTimerTask1() {
        mTimer.schedule(new TimerTask() {
            @Override
            public void run() {
                mediator.output_sname2();
                mediator.output_sprice2();
                mediator.output_sinventory2();
                handler.sendEmptyMessage(0);
            }
        }, 500);
    }
    private View.OnClickListener show_stationery_2_gui = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            mediator.show_stationery_2_GUI();
        }
    };
    public void set_name2(String n){
        this.name = n;
        System.out.println(name);
    }
    public void set_price2(int e){
        this.price = e;
    }
    public void set_inventory2(int e){
        this.inventory = e;
    }
        ...
        public void onClick(View v) {
            if(((Integer.valueOf(String.valueOf(q.getText())))<= 0) || (q.getText().toString().trim().isEmpty())){
                ...
                if(Integer.valueOf(q.getText().toString()) > inventory){
                    ...
                    mediator.intocart(2,Integer.valueOf(q.getText().toString()),Integer.valueOf(q.getText().toString())*price);
                    q.setText("");
                }
            }
        }
